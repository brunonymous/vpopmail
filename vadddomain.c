...
void usage() {
  ...
  printf(
      "         -r[len] (generate a len (default 12) char random postmaster "
      "password)\n");
  printf("\n");
  printf(
  ...
  printf(
      "   vadddomain -b delete example.com [password]  -  delete all mail to "
      "non-existant accounts\n");
  printf(
      "   vadddomain -b bounce-no-mailbox example.com [password] - bounce them "
      "\n");
  printf(
      "   vadddimain -b someone@somewhere.com example.com [password] - sent to "
      "another address\n");
  printf(
      "   vadddomain -b /path/to/Maildir example.com [password] - sent to a "
      "Maildir\n");
}
